...
export default class Module implements ChargerModuleBase {
    ...
    private static iThrottleValueRange: Range = {
        min: 12.5, // % of IChg
        max: 87.5,
        step: 12.5,
        decimals: 1,
    };
    private static tOutChargeValueRange: Range = {
        min: 1, // hours
        max: 10,
        step: 1,
        decimals: 0,
    };
    private static tOutTrickleValueRange: Range = {
        min: 10, // minutes
        max: 120,
        step: 10,
        decimals: 0,
    };
    private static vBatLowValueRange: Range = {
        min: 1.1, // voltage
        max: 2.1,
        step: 1.0,
        decimals: 1,
    };
    private static vThrottleValueRange: Range = {
        min: 25, // mV
        max: 400,
        step: 25,
        decimals: 0,
