...
| **Active Battery Health Profile** | **This option is only available for nPM1300 and nPM1304 devices.** Save or load the battery health profile that you configured in the [**Fuel Gauge**](#npm1300-and-npm1304-fuel-gauge-tab) tab.     |
